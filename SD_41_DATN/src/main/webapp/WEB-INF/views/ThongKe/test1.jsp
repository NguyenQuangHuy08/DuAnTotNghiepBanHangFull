...
<%--&lt;%&ndash;                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        Đã bán tại quầy / online&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <div class="h5 mb-0 font-weight-bold text-gray-800"&ndash;%&gt;--%>
<%--&lt;%&ndash;                                         style="margin-top: 20px">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        ${tongHoaDonTaiQuay} / ${tongHoaDonOnline}&ndash;%&gt;--%>

<%--&lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <div class="col-auto">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    <i class="fa fa-shopping-cart fa-2x text-gray-300"></i>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
...
<%--                &lt;%&ndash;                            <div class="row no-gutters align-items-center">&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                <div class="col mr-2">&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                        Sản phẩm bán chạy nhất&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                    <div class="h5 mb-0 font-weight-bold text-gray-800">${maSanPhamBanChayNhat}</div>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                    <div class="h5 mb-0 font-weight-bold text-gray-800">Đã bán: ${soLuongDaBan}</div>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                &lt;%&ndash;                                <div class="col-auto">&ndash;%&gt;--%>
...
<%--                                        &lt;%&ndash;                                                            <div class="progress-bar bg-info" role="progressbar" style="width: 20%"&ndash;%&gt;--%>
<%--                                        &lt;%&ndash;                                                                 aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>&ndash;%&gt;--%>
<%--                                        &lt;%&ndash;                                                        </div>&ndash;%&gt;--%>
<%--                                        &lt;%&ndash;                                                    </div>&ndash;%&gt;--%>
<%--                                    </div>--%>
<%--                                </div>--%>
