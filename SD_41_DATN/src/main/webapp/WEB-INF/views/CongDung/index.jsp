...
<div class="container">
    ...
    <br>
    <br>
    <form action="/congDung/search" method="get">
        <input type="text" style="width: 400px" name="tenCongDung">
        <button type="submit" class="btn btn-info btn-sm" >Tìm kiếm</button>
    </form>
    <br>
    <a href="/congDung/view-add" class="btn btn-info btn-sm"> Add </a>
    <br>
    <br>
    <div>
        <table class="table">
            ...
            <c:forEach items="${list}" var="d" varStatus="i">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/congDung/detail/${d.id}" class="btn btn-info btn-sm">Detail</a>
    ...
    <div class="d-flex justify-content-center">
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item">
                    <c:if test="${next > 0}">
                        <a class="page-link" href="/congDung/hien-thi?num=${next - 1}">Previous</a>
                    </c:if>
                </li>
                <c:forEach begin="1" end="${totalPages}" varStatus="loop">
                    <li class="page-item"><a class="page-link" href="/congDung/hien-thi?num=${loop.index - 1}">${loop.index}</a></li>
                </c:forEach>
                <li class="page-item">
                    <c:if test="${!congDungPage.last && next < totalPages - 1}">
                        <a class="page-link" href="/congDung/hien-thi?num=${next + 1}">Next</a>
                    </c:if>
                </li>
            </ul>
        </nav>
