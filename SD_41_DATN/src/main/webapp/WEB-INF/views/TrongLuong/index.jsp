        ...
        <c:forEach items="${list}" var="d" varStatus="i">
            <tr>
                ...
                <td>
                    ...
                    <a href="/trongLuong/detail/${d.id}" class="btn btn-info btn-sm">Detail</a>
...
<div class="d-flex justify-content-center">
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            <li class="page-item">
                <c:if test="${next > 0}">
                    <a class="page-link" href="/trongLuong/hien-thi?num=${next - 1}">Previous</a>
                </c:if>
            </li>
            ...
            <li class="page-item">
                <c:if test="${!trongLuongPage.last && next < totalPages - 1}">
                    <a class="page-link" href="/trongLuong/hien-thi?num=${next + 1}">Next</a>
                </c:if>
            </li>
        </ul>
    </nav>
