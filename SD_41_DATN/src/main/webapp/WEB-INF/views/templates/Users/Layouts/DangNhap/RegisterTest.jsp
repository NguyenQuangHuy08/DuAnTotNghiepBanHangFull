...
<%--</script>--%>
<%--&lt;%&ndash;<script>&ndash;%&gt;--%>
<%--&lt;%&ndash;    function addProduct() {&ndash;%&gt;--%>

<%--&lt;%&ndash;        var ten = document.getElementsByName('ten')[0].value;&ndash;%&gt;--%>
<%--&lt;%&ndash;        var ngaySinh = document.getElementsByName('ngaySinh')[0].value;&ndash;%&gt;--%>
<%--&lt;%&ndash;        var diaChi = document.getElementsByName('diaChi')[0].value;&ndash;%&gt;--%>
<%--&lt;%&ndash;        var thanhPho = document.getElementsByName('thanhPho')[0].value;&ndash;%&gt;--%>
<%--&lt;%&ndash;        var quocGia = document.getElementsByName('quocGia')[0].value;&ndash;%&gt;--%>
<%--&lt;%&ndash;        var soDienThoai = document.getElementsByName('soDienThoai')[0].value;&ndash;%&gt;--%>
<%--&lt;%&ndash;        var matKhau = document.getElementsByName('matKhau')[0].value;&ndash;%&gt;--%>

<%--&lt;%&ndash;        var errorTen = document.getElementById('errorTen');&ndash;%&gt;--%>
<%--&lt;%&ndash;        var errorNgayChon = document.getElementById('errorNgayChon');&ndash;%&gt;--%>
<%--&lt;%&ndash;        var errorDiaChi = document.getElementById('errorDiaChi');&ndash;%&gt;--%>
<%--&lt;%&ndash;        var errorThanhPho = document.getElementById('errorThanhPho');&ndash;%&gt;--%>
<%--&lt;%&ndash;        var errorQuocGia = document.getElementById('errorQuocGia');&ndash;%&gt;--%>
<%--&lt;%&ndash;        var errorSoDienThoai = document.getElementById('errorSoDienThoai');&ndash;%&gt;--%>
<%--&lt;%&ndash;        var errorMatKhau = document.getElementById('errorMatKhau');&ndash;%&gt;--%>

<%--&lt;%&ndash;        var hasError = false;&ndash;%&gt;--%>

<%--&lt;%&ndash;        if (ten.trim() === '') {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorTen.innerText = 'Vui lòng nhập tên.';&ndash;%&gt;--%>
<%--&lt;%&ndash;            hasError = true;&ndash;%&gt;--%>
<%--&lt;%&ndash;        } else {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorTen.innerText = '';&ndash;%&gt;--%>
<%--&lt;%&ndash;        }&ndash;%&gt;--%>

<%--&lt;%&ndash;        if (ngaySinh.trim() === '') {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorNgayChon.innerText = 'Vui lòng nhập ngày sinh';&ndash;%&gt;--%>
<%--&lt;%&ndash;            hasError = true;&ndash;%&gt;--%>
<%--&lt;%&ndash;        } else {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorNgayChon.innerText = '';&ndash;%&gt;--%>
<%--&lt;%&ndash;        }&ndash;%&gt;--%>

<%--&lt;%&ndash;        if (diaChi.trim() === '') {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorDiaChi.innerText = 'Vui lòng nhập địa chỉ.';&ndash;%&gt;--%>
<%--&lt;%&ndash;            hasError = true;&ndash;%&gt;--%>
<%--&lt;%&ndash;        } else {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorTen.innerText = '';&ndash;%&gt;--%>
<%--&lt;%&ndash;        }&ndash;%&gt;--%>

<%--&lt;%&ndash;        if (thanhPho.trim() === '') {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorThanhPho.innerText = 'Vui lòng nhập thành phố.';&ndash;%&gt;--%>
<%--&lt;%&ndash;            hasError = true;&ndash;%&gt;--%>
<%--&lt;%&ndash;        } else {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorTen.innerText = '';&ndash;%&gt;--%>
<%--&lt;%&ndash;        }&ndash;%&gt;--%>

<%--&lt;%&ndash;        if (quocGia.trim() === '') {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorQuocGia.innerText = 'Vui lòng nhập quốc gia.';&ndash;%&gt;--%>
<%--&lt;%&ndash;            hasError = true;&ndash;%&gt;--%>
<%--&lt;%&ndash;        } else {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorTen.innerText = '';&ndash;%&gt;--%>
<%--&lt;%&ndash;        }&ndash;%&gt;--%>

<%--&lt;%&ndash;        if (soDienThoai.trim() === '') {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorSoDienThoai.innerText = 'Vui lòng nhập số điện thoại.';&ndash;%&gt;--%>
<%--&lt;%&ndash;            hasError = true;&ndash;%&gt;--%>
<%--&lt;%&ndash;        } else {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorTen.innerText = '';&ndash;%&gt;--%>
<%--&lt;%&ndash;        }&ndash;%&gt;--%>

<%--&lt;%&ndash;        if (matKhau.trim() === '') {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorMatKhau.innerText = 'Vui lòng nhập mật khẩu.';&ndash;%&gt;--%>
<%--&lt;%&ndash;            hasError = true;&ndash;%&gt;--%>
<%--&lt;%&ndash;        } else {&ndash;%&gt;--%>
<%--&lt;%&ndash;            errorTen.innerText = '';&ndash;%&gt;--%>
<%--&lt;%&ndash;        }&ndash;%&gt;--%>

<%--&lt;%&ndash;        if (hasError) {&ndash;%&gt;--%>
