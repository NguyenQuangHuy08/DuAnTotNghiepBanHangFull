...
<%--                                        </h6>--%>
<%--                                            &lt;%&ndash;                                            <h6 class="l-through">$210.00</h6>&ndash;%&gt;--%>
<%--                                    </div>--%>
...
<%--            </c:forEach>--%>
<%--        </div>--%>
<%--        &lt;%&ndash;        Todo code phân trang&ndash;%&gt;--%>
<%--        <div class="row">--%>
...
<%--</script>--%>
<%--&lt;%&ndash;Bỏ các size và màu sắc bị trùng lặp&ndash;%&gt;--%>
<%--<script>--%>
...
<%--</script>--%>
<%--&lt;%&ndash;Change or &ndash;%&gt;--%>
<%--&lt;%&ndash;Mã js   Ajax cho số lượng size và màu sắc&ndash;%&gt;--%>
