...
<%--                    &lt;%&ndash;                                <input type="radio" class="custom-control-input" id="color-${vTri.index + 1}" name="mauSac" value="${list.id}">&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                                <label class="custom-control-label" for="color-${vTri.index + 1}">${list.ten}</label>&ndash;%&gt;--%>
<%--            </div>--%>
<%--        </c:forEach>--%>
<%--    </div>--%>
...
<%--                    &lt;%&ndash;                                <input type="radio" class="custom-control-input" id="size-${vTri.index + 1}" name="size" value="${list.id}">&ndash;%&gt;--%>
<%--                    &lt;%&ndash;                                <label class="custom-control-label" for="size-${vTri.index + 1}">${list.ten}</label>&ndash;%&gt;--%>
<%--            </div>--%>
<%--        </c:forEach>--%>
<%--    </div>--%>
