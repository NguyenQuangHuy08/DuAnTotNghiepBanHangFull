                ...
                <c:forEach items="${page.content}" var="list">
                    <tr>
                        ...
                        <td>
                            ...
                            <button style="width: 100px; font-size: 15px; margin-top: 20px" class="btn btn-primary" onclick="openModal('${list.maHoaDon}', '${list.khachHang.email}', '${list.khachHang.tenKhachHang}', '${list.ngayThanhToan}', '${list.thanhTien}', '${list.ghiChu}', event)" type="button">View</button>
                            <button formaction="/test" class="btn btn-primary">View1</button>
                        </td>
                    </tr>
                </c:forEach>
            </table>
...
<%--    </div>--%>
    ...
    <!-- Thêm id cho form -->
    <form id="cancelForm" method="post" action="/Admin/HoaDon/HuyDonHangCuaKhachHang">
        <!-- Các trường input ẩn -->
        <!-- ... -->
        <button style="width: 100px;font-size: 15px;margin-top: 20px" type="submit" class="btn btn-primary">Hủy</button>
    </form>
...
<script>
    function openModal(maHoaDon, email, tenKhachHang, ngayThanhToan, thanhTien, ghiChu, event) {
        ...
        // Hiển thị form và thêm id cho nút "Hủy"
        modalContent.innerHTML += '<button id="cancelButton" style="width: 100px;font-size: 15px;margin-top: 20px" type="button" class="btn btn-primary">Hủy</button>';

        document.getElementById("myModal").style.display = "block";

        // Gán sự kiện cho nút "Hủy" để thực hiện submit form
